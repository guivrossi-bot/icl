...
function buildStyles(C) {
  return {
    ...
    eyebrow: { fontSize: 10, letterSpacing: '3px', textTransform: 'uppercase', color: C.accent, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 },
    ...
    heroBody: { fontSize: 15, lineHeight: 1.8, color: C.muted, fontWeight: 300, maxWidth: 390, marginBottom: 28 },
    heroActions: { display: 'flex', gap: 10, alignItems: 'center' },
    btnPrimary: { fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', background: C.accent, color: '#fff', border: 'none', padding: '11px 24px', borderRadius: 3, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
    btnGhost: { fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', background: 'none', color: C.t50, border: `0.5px solid ${C.t18}`, padding: '11px 20px', borderRadius: 3, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
    ...
    statL: { fontSize: 10, letterSpacing: '1.5px', textTransform: 'uppercase', color: C.t28 },

    // PAGE SHARED
    ph: { padding: '40px 48px 28px', borderBottom: `0.5px solid ${C.border}` },
    pl: { fontSize: 10, letterSpacing: '3px', textTransform: 'uppercase', color: C.accent, marginBottom: 8, display: 'flex', alignItems: 'center', gap: 7 },
    ...
    pd: { fontSize: 14, color: C.muted, fontWeight: 300, lineHeight: 1.8, maxWidth: 520 },
    ...
    discText: { fontSize: 13, color: C.t32, lineHeight: 1.65, fontWeight: 300 },
    ...
    ts: { fontSize: 9, letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: 12, display: 'inline-flex', alignItems: 'center', gap: 4, color: C.t40 },
    ...
    tdesc: { fontSize: 13, color: C.muted, lineHeight: 1.6, marginBottom: 14, fontWeight: 300 },
    tags: { display: 'flex', gap: 5, flexWrap: 'wrap', marginBottom: 14 },
    tag: { fontSize: 9, letterSpacing: '1px', textTransform: 'uppercase', background: C.t06, color: C.t32, padding: '2px 7px', borderRadius: 2 },
    tagAmber: { fontSize: 9, letterSpacing: '1px', textTransform: 'uppercase', background: 'rgba(212,84,26,0.1)', color: 'rgba(212,84,26,0.7)', padding: '2px 7px', borderRadius: 2 },
    tcta: { fontSize: 10, letterSpacing: '1.5px', textTransform: 'uppercase', color: C.accent, background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontFamily: "'DM Sans', sans-serif" },
    ...
    fbMain: { flex: 1 },
    fbTitle: { fontSize: 13, fontWeight: 500, color: C.t72, marginBottom: 3 },
    fbSub: { fontSize: 13, color: C.t36, lineHeight: 1.55, fontWeight: 300 },
    fbCtaBtn: { fontSize: 10, letterSpacing: '1px', textTransform: 'uppercase', color: C.accent, background: 'none', border: `0.5px solid rgba(212,84,26,0.35)`, padding: '7px 16px', borderRadius: 3, cursor: 'pointer', flexShrink: 0, fontFamily: "'DM Sans', sans-serif", whiteSpace: 'nowrap' },
    ...
    mediaDesc: { fontSize: 14, color: C.muted, fontWeight: 300, lineHeight: 1.8, maxWidth: 420, marginBottom: 8 },
    notifyLbl: { fontSize: 11, letterSpacing: '1px', color: C.t28, marginBottom: 14, textTransform: 'uppercase' },
    notifyForm: { display: 'flex', gap: 7, width: '100%', maxWidth: 340 },
    notifyInput: { flex: 1, background: C.t05, border: `0.5px solid ${C.t10}`, color: C.hi, padding: '9px 12px', borderRadius: 3, fontSize: 13, fontFamily: "'DM Sans', sans-serif", outline: 'none' },
    notifyBtn: { background: C.t07, color: C.t65, border: `0.5px solid ${C.t10}`, padding: '9px 16px', borderRadius: 3, fontSize: 11, letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
    ...
    nlDesc: { fontSize: 14, color: C.muted, lineHeight: 1.8, fontWeight: 300, marginBottom: 28 },
    liBtn: { display: 'inline-flex', alignItems: 'center', gap: 9, background: '#0077b5', color: '#fff', border: 'none', padding: '11px 22px', borderRadius: 3, fontSize: 12, letterSpacing: '1px', textTransform: 'uppercase', cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" },
    ...
    nlINum: { fontSize: 9, letterSpacing: '2px', textTransform: 'uppercase', color: C.accent, marginBottom: 3 },
    nlITitle: { fontSize: 14, fontWeight: 500, color: C.t78, marginBottom: 3 },
    nlIMeta: { fontSize: 11, color: C.t25 },
    ...
    valTitle: { fontSize: 14, fontWeight: 500, color: C.hi, marginBottom: 8 },
    valDesc: { fontSize: 13, color: C.muted, lineHeight: 1.75, fontWeight: 300 },
    ...
    authorTxt: { fontSize: 12, color: C.t28 },
    ...
    chInfo: { flex: 1 },
    chLabel: { fontSize: 9, letterSpacing: '2px', textTransform: 'uppercase', color: C.t28, marginBottom: 2 },
    chVal: { fontSize: 14, color: C.t75 },
    chArr: { fontSize: 13, color: C.t22 },
    talkForm: { display: 'flex', flexDirection: 'column', gap: 10 },
    ff: { display: 'flex', flexDirection: 'column', gap: 4 },
    fl: { fontSize: 9, letterSpacing: '2px', textTransform: 'uppercase', color: C.t32 },
    fi: { background: C.t04, border: `0.5px solid ${C.t10}`, color: C.hi, padding: '9px 12px', borderRadius: 3, fontSize: 14, fontFamily: "'DM Sans', sans-serif", outline: 'none' },
